...
file_path = '../output/up_scale_han.txt'
        ...
        for p in range(10):
            ...
            for p in range(10):
                ...
                if train_mode in ['preT', 'preO', 'noFT']:
                    ...
                    decoder_p = torch.load('../pretrained_han/decoder_p.pth', weights_only=False)
                    decoder_t = torch.load('../pretrained_han/decoder_t.pth', weights_only=False)
