...
def segregate(labels, c_train_num, seed, args):
    ...
    index_list = labels[:,0]
    class_list = labels[:,1]
    num_classes = max(class_list.tolist())+1    
    c_idx = []                                         
    train_idx = []                                     
    val_idx = []
    test_idx = []
    ...
    for i in range(num_classes):                        
        ...
        c_idx = (class_list==i).nonzero()[: ,-1].tolist()   
        print(i, len(c_idx))
    ...
    train_idx = index_list[train_idx].tolist()
    val_idx = index_list[val_idx].tolist()
    test_idx = index_list[test_idx].tolist()                    
